...
class CrearEvento : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val paquetes = listOf(
            ...
            Paquete(
                "Paquete Premium",
                listOf("Permiso de alcoholes extendido", "Comida de 3 tiempos", "Decoración incluida"),
                "$200.00"
            ),
            Paquete(
                "Paquete VIP",
                listOf("Barra libre", "Chef personal", "Seguridad privada", "Entretenimiento musical"),
                "$500.00"
            )
        ...
        paquetes.forEach { paquete ->
            Log.d("CrearEvento", "Paquete: ${paquete.titulo}, Características: ${paquete.caracteristicas.joinToString()}, Precio: ${paquete.precio}")
        }
        ...
        binding.seleccionar.setOnClickListener {
            ...
            paqueteSeleccionado?.let { paquete ->
                ...
                Log.d("CrearEvento", "Evento: $nombreEvento, Fecha: $fechaEvento, Paquete: ${paquete.titulo}")
